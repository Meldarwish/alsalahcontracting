                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <i class="icon-bubble font-green-sharp"></i>
                                            <span class="caption-subject bold uppercase">{{$trans::cmslang('addnewpage')}}</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body form">
                                        <form  action="{{url('admincp/savepage')}}" method="post" method="post" enctype="multipart/form-data" role="form">
                                            <div class="form-body">
                                               {{ csrf_field() }}
                                           ...
                                           <div class="form-group">
                                                ...
                                                <select id="single" name="langkey" class="form-control select2">
                                                    ...
                                                    <div class="form-group">
                                                        <label>{{$trans::cmslang('page_key')}}</label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-text-width"></i>
                                                            </span>
                                                            <input type="text"  name="page_key" required="" class="form-control" placeholder="{{$trans::cmslang('page_key')}}"> </div>
                                                    </div>
                                            ...
                                            <!--div class="col-sm-4">
                                                <div class="form-group last">
                                                        <label class="control-label col-md-12"> {{$trans::cmslang('choose_photo')}}</label>
                                                        <div class="col-md-12">
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                    <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" /> </div>
                                                                ...
                                                                <div>
                                                                    <span class="btn default btn-file">
                                                                        <span class="fileinput-new">{{$trans::cmslang('select_image')}} </span>
                                                                        <span class="fileinput-exists"> {{$trans::cmslang('change')}}  </span>
                                                                        <input type="file" name="choose_photo"> </span>
                                                                    <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> {{$trans::cmslang('remove')}} </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <!--div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                 <label class="control-label col-md-12"> {{$trans::cmslang('choose_us')}}</label>

                                                  <textarea id="editor_2" name="choose_us" class=" form-control"   rows="4" ></textarea>
                                            <span class="help-block"></span>
                                                </div>
                                            </div>
                                        </div-->
