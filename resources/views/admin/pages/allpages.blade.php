                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                            ...
                                            @if( count($sections))
                                                ...
                                                <tr>
                                                    <td>{{$section->title}}</td>
                                                    <td><a href="{{url('/')}}/uploads/pages/{{$section->photo}}" target="blank">
                                                    <img  src="{{url('/')}}/uploads/pages/{{$section->photo}}" id="table_immg"></a> </td>
                                                    <td>{{$trans::getlangname($section->langkey)}}</td>
                                                     <td>
                                                    @if($section->stuts === 1)
                                                        <a href="{{url('/admincp/pagestuts')}}/{{$section->id}}/0" title="dicactive item" class="btn btn-icon green">
                                                          {{$trans::cmslang('yes')}} <i class="fa fa-check-square"></i>
                                                        </a>
                                                    @endif

                                                    @if($section->stuts === 0)
                                                        <a href="{{url('/admincp/pagestuts')}}/{{$section->id}}/1" title="active item" class="btn btn-icon dark">
                                                    ...
                                                    <td>
                                                      <a title="{{$trans::cmslang('edit')}}" href="{{url('/admincp/editpage')}}/{{$section->id}}" class="btn btn-sm green-meadow"> {{$trans::cmslang('edit')}} <i class="fa fa-edit"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                      <a href="{{url('/admincp/deletepage')}}/{{$section->id}}"
