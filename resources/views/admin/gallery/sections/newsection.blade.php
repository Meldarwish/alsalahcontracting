                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <i class="icon-bubble font-green-sharp"></i>
                                            <span class="caption-subject bold uppercase">{{$trans::cmslang('newgallerysection')}}</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body form">
                                        <form  action="{{url('admincp/savegallerysection')}}" method="post" method="post" enctype="multipart/form-data" role="form">
                                            <div class="form-body">
                                               {{ csrf_field() }}
                                           ...
                                           <div class="form-group">
                                                <label for="single" class="control-label">{{$trans::cmslang('gallery_type')}}</label>
                                                <select id="single" name="gallery_type" class="form-control select2">
                                                    ...
                                                    <div class="form-group last col-md-6">
                                                        <label class="control-label col-md-12"> {{$trans::cmslang('uploadphotos')}}</label>
                                                        <div class="col-md-12">
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                ...
                                                                <div>
                                                                    <span class="btn default btn-file">
                                                                        ...
                                                                        <input type="file" multiple name="photo"> </span>
