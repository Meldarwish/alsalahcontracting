                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">{{$trans::cmslang('menulocations')}}</span>
                                        </div>
                                        <div class="tools"> </div>
                                    </div>
                                            ...
                                            @if( count($sections))
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$trans::getlangname($section->langkey)}}</td>
                                                     <td>
                                                    @if($section->stuts === 1)
														<a href="{{url('/admincp/menulocationstuts')}}/{{$section->id}}/0" title="dicactive item" class="btn btn-icon green">
                                                          {{$trans::cmslang('yes')}} <i class="fa fa-check-square"></i>
                                                        </a>
                                                    @endif

                                                    @if($section->stuts === 0)
														<a href="{{url('/admincp/menulocationstuts')}}/{{$section->id}}/1" title="active item" class="btn btn-icon dark">
                                                    ...
                                                    <td>
												      <a title="{{$trans::cmslang('edit')}}" href="{{url('/admincp/editmenulocation')}}/{{$section->id}}" class="btn btn-sm green-meadow"> {{$trans::cmslang('edit')}} <i class="fa fa-edit"></i>
                                                        </a>
                                                    </td>
                                                    <td>
												      <a href="{{url('/admincp/deletmenulocation')}}/{{$section->id}}"
