                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
                                       <form  action="{{url('admincp/updatemenulocation')}}/{{$row->id}}" method="post" method="post" enctype="multipart/form-data" role="form">
                                            <div class="form-body">
                                               {{ csrf_field() }}
                                                ...
                                                <select id="single" name="langkey" class="form-control select2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  name="title"  value="{{$row->title}}" required="" class="form-control" placeholder="{{$trans::cmslang('menulocationname')}} "> </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  name="code" value="{{$row->code}}" required="" class="form-control" placeholder="{{$trans::cmslang('menulocationcode')}} "> </div>
                                                    </div>
