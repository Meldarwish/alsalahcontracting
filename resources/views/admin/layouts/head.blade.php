...
<html lang="en">
    ...
    <head>
        ...
        <link href=" {{asset('admin/global/plugins/font-awesome/css/font-awesome.min')}}" rel="stylesheet" type="text/css" />
        <link href=" {{asset('admin/global/plugins/simple-line-icons/simple-line-icons.min')}}" rel="stylesheet" type="text/css" />
        <link href=" {{asset('admin/global/plugins/bootstrap/css/bootstrap.min')}}" rel="stylesheet" type="text/css" />
        <link href=" {{asset('admin/global/plugins/bootstrap-switch/css/bootstrap-switch.min')}}" rel="stylesheet" type="text/css" />
        <!-- END GLOBAL MANDATORY STYLES -->
        <!-- BEGIN THEME GLOBAL STYLES -->
        <link href=" {{asset('admin/global/css/components-md.min')}}" rel="stylesheet" id="style_components" type="text/css" />
        <link href=" {{asset('admin/global/css/plugins-md.min')}}" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <link href=" {{asset('admin/layouts/layout/css/layout.min')}}" rel="stylesheet" type="text/css" />
        <link href=" {{asset('admin/layouts/layout/css/themes/darkblue.min')}}" rel="stylesheet" type="text/css" id="style_color" />
        <link href=" {{asset('admin/layouts/layout/css/custom.min')}}" rel="stylesheet" type="text/css" />
