...
<head>
    ...
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all" rel="stylesheet"
        type="text/css" />
    <link href=" {{ asset('public/admin/global/plugins/font-awesome/css/font-awesome.min') }}" rel="stylesheet"
        type="text/css" />
    <link href=" {{ asset('public/admin/global/plugins/simple-line-icons/simple-line-icons.min') }}" rel="stylesheet"
        type="text/css" />
    <link href=" {{ asset('public/admin/global/plugins/bootstrap/css/bootstrap.min') }}" rel="stylesheet"
        type="text/css" />
    <link href=" {{ asset('public/admin/global/plugins/bootstrap-switch/css/bootstrap-switch.min') }}" rel="stylesheet"
        type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN THEME GLOBAL STYLES -->
    <link href=" {{ asset('public/admin/global/css/components-md.min') }}" rel="stylesheet" id="style_components"
        type="text/css" />
    <link href=" {{ asset('public/admin/global/css/plugins-md.min') }}" rel="stylesheet" type="text/css" />
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN THEME LAYOUT STYLES -->
    <link href=" {{ asset('public/admin/layouts/layout/css/layout.min') }}" rel="stylesheet" type="text/css" />
    <link href=" {{ asset('public/admin/layouts/layout/css/themes/darkblue.min') }}" rel="stylesheet" type="text/css"
        id="style_color" />
    <link href=" {{ asset('public/admin/layouts/layout/css/custom.min') }}" rel="stylesheet" type="text/css" />
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item ">
                                            <a href="ui_page_progress_style_2.html" class="nav-link "> Big Counter
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item ">
                                            <a href="table_datatables_ajax.html" class="nav-link "> Ajax Datatables
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="nav-item ">
                                            <a href="page_general_portfolio_1.html" class="nav-link "> Portfolio 1
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a href="page_general_portfolio_2.html" class="nav-link "> Portfolio 2
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a href="page_general_portfolio_3.html" class="nav-link "> Portfolio 3
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a href="page_general_portfolio_4.html" class="nav-link "> Portfolio 4
                                            </a>
                                        </li>
                                    </ul>
                                </li>
