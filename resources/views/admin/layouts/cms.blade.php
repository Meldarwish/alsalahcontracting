...
<link href="{{asset('admin/assets/global/plugins/bootstrap/css/')}}/bootstrap{{$dir}}.min.css" rel="stylesheet" type="text/css" />
<link href="{{asset('admin/assets/global/plugins/bootstrap-switch/css/')}}/bootstrap-switch{{$dir}}.min.css" rel="stylesheet" type="text/css" />
<!-- END GLOBAL MANDATORY STYLES -->
<link href="{{asset('admin/assets/global/plugins/bootstrap-toastr/toastr.min.css')}}" rel="stylesheet" type="text/css" />
<!-- BEGIN THEME GLOBAL STYLES -->
<link href="{{asset('admin/assets/global/css/')}}/components-md{{$dir}}.min.css" rel="stylesheet" id="style_components" type="text/css" />
<link href="{{asset('admin/assets/global/css/')}}/plugins-md{{$dir}}.min.css" rel="stylesheet" type="text/css" />
<!-- END THEME GLOBAL STYLES -->

<link href="{{asset('admin/assets/global/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('admin/assets/global/plugins/bootstrap-tagsinput/bootstrap-tagsinput-typeahead.css')}}" rel="stylesheet" type="text/css" />
...
<link href="{{asset('admin/assets/global/plugins/datatables/plugins/bootstrap/')}}/datatables.bootstrap{{$dir}}.css" rel="stylesheet" type="text/css" />
...
<link href="{{asset('admin/assets/layouts/layout/css/')}}/layout{{$dir}}.min.css" rel="stylesheet" type="text/css" />
<link href="{{asset('admin/assets/layouts/layout/css/themes/')}}/darkblue{{$dir}}.min.css" rel="stylesheet" type="text/css" id="style_color" />
<link href="{{asset('admin/assets/layouts/layout/css/custom.min.css')}}" rel="stylesheet" type="text/css" />
<!-- END THEME LAYOUT STYLES -->
        {{-- <link href="{{asset('admin/font.css')}}" rel="stylesheet" type="text/css" /> --}}
        <style type="text/css">
            @font-face{
                font-family:'bahaa_elden';
                src:url('{{asset('admin/font/janna_regular.woff')}}') format('embedded-opentype'),
                    url('{{asset('admin/font/janna_regular.eot')}}') format('woff'),
                    url('{{asset('admin/font/janna_regular.ttf')}}') format('truetype');
                    Cloudward;
            }
              *{
                font-family:'bahaa_elden';
            }
            h1,h2,h3,h4,h5,.page-title,.page-header.navbar .hor-menu .navbar-nav > li .dropdown-menu li > a{
                font-family:'bahaa_elden';
...
<link rel="shortcut icon" href="favicon.ico" /> </head>
    ...
    <body  class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md">
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="{{asset('admin/assets/global/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js')}}" type="text/javascript"></script>
        ...
        <script src="{{asset('admin/assets/pages/scripts/components-bootstrap-maxlength.min.js')}}" type="text/javascript"></script>

        <script src="{{asset('admin/assets/global/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js')}}" type="text/javascript"></script>
        <script src="{{asset('admin/assets/global/plugins/typeahead/handlebars.min.js')}}" type="text/javascript"></script>
        <script src="{{asset('admin/assets/global/plugins/typeahead/typeahead.bundle.min.js')}}" type="text/javascript"></script>
        ...
        <script src="{{asset('admin/assets/pages/scripts/form-repeater.min.js')}}" type="text/javascript"></script>
        <script src="{{asset('admin/assets/pages/scripts/table-datatables-fixedheader.min.js')}}" type="text/javascript"></script>
        ...
        <script src="{{asset('admin/assets/pages/scripts/components-bootstrap-tagsinput.min.js')}}" type="text/javascript"></script>
      ...
      <script src="{{asset('admin/ck/ckeditor/ckeditor.js')}}" type="text/javascript" ></script>
      <script src="{{asset('admin/ck/ckfinder/ckfinder.js')}}" type="text/javascript" ></script>
      <!-- setup ck efitor -->
