                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
                                       <form  action="{{url('admincp/updatetourcategory')}}/{{$row->id}}" method="post" method="post" enctype="multipart/form-data" role="form">
                                            <div class="form-body">
                                               {{ csrf_field() }}
                                                ...
                                                <div class="col-sm-8">                    
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="{{$row->title}}"  name="title" required="" class="form-control" placeholder="Add Category Name"> </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label> SEO Frindly URl for section  </label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-text-width"></i>
                                                            </span> 
                                                            <input type="text" value="{{urldecode($row->url)}}" name="url" required="" class="form-control" placeholder=" SEO Frindly URl for section here "> </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label col-md-12"> Section  Description here</label>
                                                        <div class="col-md-12">
                                                            <textarea class="form-control" name="content"  rows="4" placeholder="Enter Section  Description here">{{$row->content}}</textarea>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                    <img src="{{url('/uploads/blog/sections/')}}/{{$row->photo}}" alt="" /> </div>
