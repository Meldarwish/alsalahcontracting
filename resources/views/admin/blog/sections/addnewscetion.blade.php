                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <i class="icon-bubble font-green-sharp"></i>
                                            <span class="caption-subject bold uppercase">
                                              {{$trans::cmslang('newblogsections')}}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="portlet-body form">
                                        <form  action="{{url('admincp/savesblogsection')}}" method="post" method="post" enctype="multipart/form-data" role="form">
                                            <div class="form-body">
                                               {{ csrf_field() }}
                                                ...
                                                <select id="single" name="langkey" class="form-control select2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  name="title" required="" class="form-control" placeholder="{{$trans::cmslang('sectionname')}} "> </div>
                                                    </div>
