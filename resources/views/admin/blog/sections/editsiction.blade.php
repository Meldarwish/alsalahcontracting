                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <i class="icon-bubble font-green-sharp"></i>
                                            <span class="caption-subject bold uppercase">{{trans::cmslang('edit')}} {{trans::cmslang('blogsections')}}</span>
                                        </div> 
                                    </div>       
                                    <div class="portlet-body form">
                                       <form  action="{{url('admincp/updateblogsection')}}/{{$row->id}}" method="post" method="post" enctype="multipart/form-data" role="form">
                                            <div class="form-body">
                                               {{ csrf_field() }}
                                           ...
                                           <div class="form-group">
                                                ...
                                                <select id="single" name="langkey" class="form-control select2">
                                                    ...
                                                    <div class="form-group">
                                                        <label> {{trans::cmslang('sectionname')}} </label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-text-width"></i>
                                                            </span>
                                                            <input type="text" value="{{$row->title}}"  name="title" required="" class="form-control" placeholder="Add session title"> </div>
                                                    </div>
                                        ...
                                        <div class="col-sm-12">                                         
                                                <div class="form-group">
                                                    <label class="control-label col-md-12"></label>
                                                       <div class="col-md-12">
                                                         <span class="help-block"> {{trans::cmslang('seo_desc')}} </span>
