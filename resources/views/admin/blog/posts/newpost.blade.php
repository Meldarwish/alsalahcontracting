                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <i class="icon-bubble font-green-sharp"></i>
                                            <span class="caption-subject bold uppercase">{{trans::cmslang('newpost')}}</span>
                                        </div> 
                                    </div> 		 
                                    <div class="portlet-body form">
                                        <form  action="{{url('admincp/savespost')}}" method="post" method="post" enctype="multipart/form-data" role="form">
                                            <div class="form-body">
                                               {{ csrf_field() }}
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <!--div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  name="aouther"  class="form-control" placeholder="{{trans::cmslang('writter')}}"> </div>
                                                    </div-->

                                                    <!--div class="form-group">
                                                        <label class="control-label col-md-12">{{trans::cmslang('short_info')}}</label>
                                                        <div class="col-md-12">
                                                            <textarea class="form-control" name="short_desc"  rows="4" placeholder=""></textarea>
