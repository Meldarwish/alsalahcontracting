...
@section('content')
    ...
    <div class="section-full  p-t80 p-b50 bg-cover"
        style="background-image:url({{ asset('public/interface/images/background/bg7.jpg') }})">
                ...
                <div class="contact-one">
                    ...
                    <div class="row  d-flex justify-content-center flex-wrap">
                        ...
                        <div class="col-lg-6 col-md-6 m-b30">
                            <form class="cons-contact-form" action="{{ route('message') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <input name="name" type="text" required class="form-control"
                                                placeholder="{{ __('layout.contact.name') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <input name="phone" type="text" class="form-control" required
                                                placeholder="{{ __('layout.contact.phone') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <input name="subject" type="text" class="form-control" required
                                                placeholder="{{ __('layout.contact.subject') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit"
                                            class="site-button site-btn-effect">{{ __('layout.contact.submit') }}</button>
                                    </div>
                            ...
                            <div class="contact-info">
                                <div class="contact-info-inner">
                                    ...
                                    <div class="contact-info-section"
                                        style="background-image:url({{ asset('public/interface/images/background/bg-map2.png') }});">
        ...
        <div class="section-content">
            <div class="container">
                <div class="gmap-outline">
                    <div id="gmap_canvas2" class="google-map"><iframe
                            src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d999.9890530871202!2d31.30083585859879!3d30.101804885224443!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2seg!4v1666635939506!5m2!1sen!2seg"
