...
<div class="container">
    ...
    <div class="portfolio-item row">
       ...
       <div class="item col-lg-3 col-md-4 col-6 col-sm">
          <a href="{{asset('uploads/gallery/')}}{{'/'.$photo->photo}}" class="fancylight popup-btn" data-fancybox-group="light"> 
          <img class="img-fluid" src="{{asset('uploads/gallery/')}}{{'/'.$photo->photo}}" alt="">
          </a>
       </div>
       @endforeach
