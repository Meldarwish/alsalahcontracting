                ...
                <ul>
                    @foreach ($sliders as $slider)
                        ...
                        <li data-index="rs-901" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            data-masterspeed="default" data-thumb="{{ $slider->photo }}" data-rotate="0"
                    ...
                    {"delay":"wait","speed":1000,"to":"opacity:0;","ease":"Power4.easeOut"}
                            ...
                            <div class="tp-caption   tp-resizeme site-text-primary rev-title-left-border"
                                id="slide-901-layer-2" data-x="['left','left','left','left']"
                                data-hoffset="['34','34','34','30']" data-y="['top','top','top','top']"
                                data-voffset="['160','160','160','160']" data-fontsize="['48','48','48','34']"
                                data-lineheight="['48','48','48','48']" data-width="['700','700','96%','96%']"
